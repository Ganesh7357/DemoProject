...
import NotificationCount from '../Screen/Notification/NotificationCount';
...
{rightIcon && (
        ...
        <NotificationCount  rightIcon={rightIcon}  onClickrightIcon={onClickrightIcon} navigation={navigation}/>
      )}
    </View>
  );
}
