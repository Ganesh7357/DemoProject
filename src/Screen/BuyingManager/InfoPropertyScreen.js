...
const InfoPropertyScreen = ({ navigation, route }) => {
                ...
                <View style={styles.mainSpace}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Party Name Mr./Mrs. :'} style={styles.titleStyle222} />
                        </View>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Company Name :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Mediator Name :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Mediator Contact no :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Contact Number :'} style={styles.titleStyle222} />
                        </View>
                        <View style={[styles.view2]}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Scheme Name  :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Scheme Add  :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                            <Caption text={empData?.email} style={styles.titleStyle} />
                        </View>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Property Title :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Property Details :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Total Deal (Amount) :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Deal / pan :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Remark :'} style={styles.titleStyle222} />
                        </View>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Documents Type (Give to Prty) :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Documents Type (Recevied from Prty) :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Old Doc. Receiving Date :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                            <Caption text={empData?.permanentAddress} style={styles.titleStyle} />
                        </View>
                    ...
                    <View style={styles.topTabMainViewcss}>
                        <View style={styles.view1}>
                            <Caption text={'Receiver Associate :'} style={styles.titleStyle222} />
                        </View>
                        <View style={styles.view2}>
                            <Caption text={empData?.permanentAddress} style={styles.titleStyle} />
                        </View>
...
export default InfoPropertyScreen;
